...
/**
 * Planner output schema (O1 — structured outputs everywhere).
 *
 * Vault canon: `Build/Prompts/planner.md` §Output.
 *
 * Shape is intentionally rigid — orchestrator branches on `status` enum,
